...
#---------------------------------------------------------------
#  Azure Container Instance (ACI) Resource
#---------------------------------------------------------------

resource "azurerm_container_group" "aci" {
  name = local.azure_container_instance_name
  ...
  dns_name_label              = var.vnet_integration_enabled ? null : coalesce(var.dns_name_label, local.azure_container_instance_name)
